  ...
  var pokerShoreApp = angular.module('pokerShoreApp', [
    ...
    pokerShoreApp.service('signalRSvc', ['$', '$rootScope','$timeout', function ($, $rootScope,$timeout) {
        ...
        var initialize = function () {
            ...
            var onProxyVarsArray = ['roomCreated', 'roomJoined', 'getParticipants', 'getPBIS', 'PBIPushed', 'addedEstimation', 'getUserEstimates', 'showEstimates', 'finalEstimateSet', 'updatedPBI'];
